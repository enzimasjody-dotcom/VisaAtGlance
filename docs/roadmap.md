...
| 4 | 공개 dashboard MVP | 예정 |
| 5 | timeline 입력 기반 즉시 visualization | 예정 |
| 6 | source freshness와 data limitation 표시 | 예정 |
| 7 | 로그인, saved timeline, alerts | 예정 |
...
- ingestion을 바로 늘리기 전에 backend domain model과 privacy guard를 먼저 두어 데이터 공개 위험을 줄인다.
...
- 로그인/alerts/premium은 retention과 수익화에 중요하지만, cohort/source/privacy foundation 뒤에 진행한다.
...
### Phase 2 — backend foundation과 ingestion prototype
