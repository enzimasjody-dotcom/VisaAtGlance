...
| 작업 | 내용 | 완료 기준 |
|---|---|---|
| public overview | 핵심 지표와 public chart 첫 화면 | 진행 중: `GET /dashboard/public` aggregate API 완료, frontend chart UI 후속 |
| timeline dashboard | i485tracker-like normalized timeline aggregate statistics와 chart | 다음 작업: frontend에서 public dashboard API를 읽어 chart로 표시 |
